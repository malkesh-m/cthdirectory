...
class CheckoutScreen extends React.Component{
    ...
    static getDerivedStateFromProps(props, state) {
        ...
        if( bk_status != '' && bk_status != 'completed' ){
            ...
            return {waitingPayment: false, comSubmitted: true, paymentCompleted: true }
        }
    ...
    render(){
        ...
        const _self = this
        const {apColors} = this.props;
        const {notes,focus,payBtnText,waitingPayment,comSubmitted,paymentCompleted} = this.state
