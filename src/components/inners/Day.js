...
export default class Day extends React.Component{
    ...
    shouldComponentUpdate(nextProps) {
  	...
  	render(){
        ...
        let notPast = null != marking.notPast && marking.notPast === true ? true : false;
        let disabled = null != marking.disabled && marking.disabled === true ? true : false;
        let selected = null != marking.selected && marking.selected === true ? true : false;
        // period selected days
        let startingDay = null != marking.startingDay && marking.startingDay === true ? true : false;
        let endingDay = null != marking.endingDay && marking.endingDay === true ? true : false;
        let inPeriod = null != marking.inPeriod && marking.inPeriod === true ? true : false;
        // simple selected day
        let singleDay = null != marking.singleDay && marking.singleDay === true ? true : false;

        let prMeta = null != marking.prmeta ? marking.prmeta : '';
        let cusStyle = {}
        let dayStyle = {}
